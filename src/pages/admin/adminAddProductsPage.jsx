...
export default function adminAddProductsPage(){
    ...
    return(
        <div className="w-full h-full  max-h-full flex flex-wrap items-start overflow-y-scroll hide-scroll-track">
      ...
      <textarea  value={description}   onChange={(e)=>{setDescription(e.target.value)}}
            ...
            <div className="w-[100%] h-[120px] flex flex-col">
                 ...
                 <input  value={altNames} onChange={(e)=>{setAltNames(e.target.value)}}
                  placeholder="Ex:Laptop,notebook,computer" className="border-4 border-accent rounded-[10px] h-[50px] p-2 m-2 focus:outline-white"/>
            </div>
             <div className="w-[50%] h-[120px] flex flex-col">
           ...
           <div className="w-full h-[80px] bg-white sticky bottom-0 rounded-b-2xl flex justify-end items-center p-4 gap-4">
            <button className="bg-gray-500 text-white font-bold px-6 py-3 rounded-[10px] hover:bg-gray-500 ml-4">Cancel</button>
            <button onClick={handleAddProducts} className="bg-accent text-white font-bold px-6 py-3 rounded-[10px] hover:bg-secondary">Add Products</button>
